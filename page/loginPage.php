...
<html lang="en">
    ...
    <body>
        ...
        <div class="bg bg-light text-dark" style="background-image: url('../resource/carousel1.png');">
                    ...
                    <div class="card-body">
                        <form action="../process/loginProcess.php" method="post">
                            <div class="mb-3">
                                ...
                                <input type= "email" class="form-control" id="email" name="email" required placeholder="example@gmail.com" aria-describedby="emailHelp">
                            </div>
