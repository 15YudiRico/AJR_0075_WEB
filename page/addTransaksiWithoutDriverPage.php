...
<?php
    ...
    if(mysqli_num_rows($query) !=0){
        ...
        echo'<script>alert("Silahkan Melengkapi Data SIM Anda!"); window.location = "./profilCustomerPage.php"</script>';
    }else{
        if(isset($_POST['add'])){
            include('../db.php');
            ...
            if($date1 < $date3){
                echo'<script>alert("Durasi Waktu Sewa Minimal Sehari!"); window.location = "./addTransaksiWithoutDriverPage.php"</script>';
                ...
                echo'<script> window.location = "./listAsetMobilCustomerPage.php?stats=0&selisih_waktu_sewa='.$selisih_waktu_sewa->days.'"</script>';
            }        
        }
        ...
        <hr>
            <form action="./addTransaksiWithoutDriverPage.php" method="post">
                <div class="mb-3">
