    ...
    <h4>SHOW CUSTOMER</h4>
        <form>
            <div class="row mt-3 form-control">
                ...
                <div class="mb-3"><label class="labels">Link SIM </label>
                    <input class="form-control" disabled value="<?php if($user[8]!=NULL) {echo $user[8];}else{echo '-';}?>">
                </div>
                <div class="mb-3"><label class="labels">Link Tanda Pengenal (KTP/Kartu Pelajar) </label>
                    <input class="form-control" disabled value="<?php if($user[9]!=NULL) {echo $user[9];}else{echo '-';}?>">
                </div>
            </div>
        </form>
            <div class="mt-4 text-center">
                <a href="./verifikasiCustomerPage.php" class="btn btn-primary" role="button" aria-disabled="true">Back</a>
            </div>
</div>
</aside>
