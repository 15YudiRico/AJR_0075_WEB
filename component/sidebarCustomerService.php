                    ...
                    <div class="side-bar">
                        ...
                        <div class="menu">
                            ...
                            <div class="content-menu " >
                                ...
                                <a href="./verifikasiCustomerPage.php" style="font-weight:600">Verify Customer</a>
                            </div>
                            <div class="content-menu " >
                                <i class="fa fa-check-square-o"></i>
                                <a href="./verifikasiTransaksiPenyewaanPage.php" style="font-weight:600">Verify Transaksi Penyewaan</a>
                            </div>
                            <div class="content-menu " >
                                <i class="fa fa-check-square-o"></i>
                                <a href="./verifikasiTransaksiPembayaranPage.php" style="font-weight:600">Verify Transaksi Pembayaran</a>
                            </div>
                            <div class="content-menu " >
